# openshift-analysis
Analysis pod for debugging: deploy within your project (and the OpenShift SDN) and run `ab`, `dig`, `netstat`, `nslookup`, `telnet`, `traceroute`, `wget`, and so on as well as database clients for MySQL and PostgreSQL.
